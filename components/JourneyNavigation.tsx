...
export default function JourneyNavigation({
  ...
  const clearTransitionTimers = useCallback(function clearTransitionTimers() {
  ...
  const navigateToStation = useCallback(
    function navigateToStation(targetId: StationId) {
  ...
  useEffect(
    function listenForJourneyRequests() {
